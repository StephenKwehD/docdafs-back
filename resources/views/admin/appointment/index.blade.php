    ...
    <div class="card">
        <div class="card-header">
            ...
            <span style="margin-left: 700px">
                    Check/Uncheck
                    <input type="checkbox" onclick="for(c in document.getElementsByName('time[]')) { var checkbox = document.getElementsByName('time[]').item(c); if (checkbox.value.endsWith('am')) checkbox.checked = this.checked; }">
            </span>
        </div>
        ...
        <div class="card-header">
            ...
            <span style="margin-left: 700px">
                    Check/Uncheck
                    <input type="checkbox" onclick="for(c in document.getElementsByName('time[]')) { var checkbox = document.getElementsByName('time[]').item(c); if (checkbox.value.endsWith('pm')) checkbox.checked = this.checked; }">
            </span>
        </div>
        <div class="card-body">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap-datetime-picker-v2/build/js/bootstrap-datetimepicker.min.js"></script>
